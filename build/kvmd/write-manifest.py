...
manifest = dict(schema_version=1,
    ...
    upstream=dict(url='https://github.com/pikvm/kvmd', tag='v4.213',
                  ...
                  downstream_patches={'build/kvmd/video-only.patch':record(repo/'build/kvmd/video-only.patch')}),
    baseline=dict(tag='ubuntu-26.04.1-ustreamer-baseline', rootfs=record(repo/'out/ustreamer/artifacts/rootfs.tar.gz')),
    ...
    acceptance=dict(m8a='not_qualified',m6='deferred',m75='frozen'))
