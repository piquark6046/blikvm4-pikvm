#!/usr/bin/env python3
"""Independent H5R1 functional archive and frozen browser/HID/SCSI replay."""
import argparse
import ast
import hashlib
import io
...
def replay(archive, expected, name):
    ...
    with tempfile.TemporaryDirectory(prefix='h5r1-functional-replay-') as temporary,tarfile.open(archive) as t:
        ...
        assert before['boot_id']=='eecefe38-98a3-406c-9260-3e51de321ffe'
        def generations(inv):
        ...
        result.update(result='H5R1_FUNCTIONAL_ACCEPTED',name=name,archive_sha256=expected,
