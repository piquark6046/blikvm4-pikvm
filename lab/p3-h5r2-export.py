#!/usr/bin/env python3
"""Append-only private H5R2 snapshot; no launch or target operation."""
import json
import os
...
def main():
    P=runpy.run_path(str(Path(__file__).with_name('p3-h5r2.py')))
    ...
    exports=Path('/home/user/blikvm-p3-h5r2-exports')
