...
try:
    ...
    browser=subprocess.Popen(['/usr/bin/python3',str(Path(__file__).with_name('p3-h5r1-functional.py')),'browser','msd'],stdout=(a.output/'browser.log').open('w'),stderr=subprocess.STDOUT,stdin=subprocess.DEVNULL,close_fds=True)
