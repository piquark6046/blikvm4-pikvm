...
try:
 ...
 with contextlib.ExitStack() as stack:
  ...
  browser=subprocess.Popen(['/usr/bin/python3',str(Path(__file__).with_name('p3-h5r2-functional.py')),'browser','hid'],stdout=log,stderr=subprocess.STDOUT,stdin=subprocess.DEVNULL,close_fds=True)
