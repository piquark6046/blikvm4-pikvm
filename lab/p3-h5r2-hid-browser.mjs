...
const {chromium}=require('/var/lib/blikvm-p3-h5r2/input/runtime/node_modules/playwright');
...
const launchGate=require('/var/lib/blikvm-p3-h5r2/input/functional/lab/p3-h5r2-launch.cjs');
